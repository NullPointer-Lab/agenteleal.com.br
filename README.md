...
Landing page estática para `agenteleal.com.br`, publicada via GitHub Pages.

## Domínio

Custom domain esperado: `agenteleal.com.br`.

DNS recomendado no Registro.br/Cloudflare:

- `A agenteleal.com.br -> 185.199.108.153`
